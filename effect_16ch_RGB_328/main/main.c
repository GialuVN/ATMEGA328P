...
int main(void)
{
    ...
    while(1)
    {
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(4),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(5),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(6),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),5,1,20);
		//
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),5,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),5,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),5,1,200);
		...
		//
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),5,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),5,1,20);
		...
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(4),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(5),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(6),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,2,20);
		
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,2,20);
		RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,2,20);
		...
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(4),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(5),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(6),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,1,20);
		//
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),1,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),1,1,20);
		...
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(4),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(5),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(6),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),8,1,20);
		//
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),8,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),8,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,200);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(7),8,1,200);
		...
		//
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(1),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(2),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(3),8,1,20);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(0),8,1,20);
...
//RGB_gen_color_linear(RGB,0,4,10,10,100,0);
		 //RGB_set_base_color(RGB,0,4,50,50,50);
		//RGB_out_to_lpd(RGB,5);
		//_delay_ms(1000);
		 //RGB_set_base_color(RGB,0,4,0,0,0);
		 //RGB_out_to_lpd(RGB,5);
		 //_delay_ms(1000);
		
//RGB_gen_soft_two_color(RGB,_BOT,_TOP,RGB_base_convert(red),RGB_base_convert(green),1,1,100,0);

		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(red),1,1,1000);
		//RGB_color_change_sys(RGB,_BOT,_TOP,RGB_base_convert(green),1,1,1000);
