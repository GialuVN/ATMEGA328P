...
int main(void)
{
    ...
    while (1) 
    {
		...
		else
		{
			...
			//for (unsigned int i = 0;i<256;i++)
			//{
				//out_color(color_convert(255,i,0));
				//delayms(_speed);
				//if (!(PINC&(1<<PINC5)))
				//{
					//if (_speed>=20) _speed = 1;
			...
			//for (unsigned int i = 0;i<256;i++)
			//{
				//out_color(color_convert(255,255,i));
				//delayms(_speed);
				//if (!(PINC&(1<<PINC5)))
				//{
					//if (_speed>=20) _speed = 1;
			...
			//for (unsigned int i = 0;i<256;i++)
			//{
				//out_color(color_convert(255-i,255,255));
				//delayms(_speed);
				//if (!(PINC&(1<<PINC5)))
				//{
					//if (_speed>=20) _speed = 1;
			...
			//for (unsigned int i = 0;i<256;i++)
			//{
				//out_color(color_convert(0,255-i,255));
				//delayms(_speed);
				//if (!(PINC&(1<<PINC5)))
				//{
					//if (_speed>=20) _speed = 1;
			...
			//for (unsigned int i = 0;i<256;i++)
			//{
				//out_color(color_convert(0,0,255-i));
				//delayms(_speed);
				//if (!(PINC&(1<<PINC5)))
				//{
					//if (_speed>=20) _speed = 1;
