...
void odd_even(uint8_t bot,uint8_t top,volatile uint8_t *gray,uint8_t speed,uint8_t repeat,uint8_t step);
void n_rota(uint8_t bot,uint8_t top,volatile uint8_t *gray,uint8_t direct,uint8_t speed,uint16_t repeat );
void border(uint8_t bot,uint8_t top,volatile uint8_t *gray,uint8_t speed,uint8_t repeat,const uint8_t *point,uint8_t type);
void load_value(uint8_t bot,uint8_t top,volatile uint8_t *gray,const uint8_t *point);
void random_light_st1(uint8_t bot,uint8_t top,volatile uint8_t *gray,uint8_t speed,uint16_t repeat,uint8_t max_sleep);
void random_light_st2(uint8_t bot,uint8_t top,volatile uint8_t *gray,uint8_t speed,uint16_t repeat);
