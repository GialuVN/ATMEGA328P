...
#define TWI_BUFFER_SIZE 65  // Set this to the largest message size that will be sent including address byte.

#define TWI_TWBR            40        // TWI Bit rate Register setting.// bit rate =clk/div(160000000/40=400k)
...
unsigned char Dec2bcd(unsigned char decimal);
